...
## 2024-08-01 - Debouncing Full DOM Rebuilds
**Learning:** Rapid DOM updates via `innerHTML` replacement (such as regenerating the entire track grid during search filtering) cause significant main thread blocking in this static architecture.
