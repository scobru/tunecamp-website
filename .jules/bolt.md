...
## 2025-02-14 - Debouncing DOM rebuilds
**Learning:** Rapid DOM updates via `innerHTML` replacement during search filtering cause significant main thread blocking in this frontend architecture.
